...
Tokoh adalah parodi atau karakter komposit. Game membedakan tudingan, bantahan, dakwaan, vonis, upaya hukum, pemeriksaan resmi, dan opini. Istilah polemis tidak disajikan sebagai status hukum. Episode setelah Juli 2026 diberi label **FIKSI PREDIKTIF**.

## Fitur

- Dua jalur: Buzzer dan Aktivis.
- 72 episode bulanan dan special events.
- Action cards issue-aware dan terkunci setelah dipakai dalam satu fase.
- Tim dan Mentor dengan ability sekali pakai per fase.
- Ekonomi progresif, utang, bunga, bailout, dan bangkrut.
- Komentar netizen yang merespons isi tweet dan action pemain.
- Autosave dan Continue melalui `localStorage`.
- Ending Pemilu 2029 terbuka dan tidak memilihkan kandidat.
