/**
 * Perang Narasi: Republik Timeline v3.8.1
...
(() => {
  ...
  function updateContinuePanel() {
    ...
    if (data) {
      ...
      $("#continueSummary").textContent =
        `${roleData[s.role].label} • Fase ${(s.phase || 0) + 1}/6 • ${i?.month || "bulan tersimpan"} • ${Math.round(s.reach || 0)} jangkauan`;
    }
  }
    ...
    buzzer: [
      ...
      [
        {
          id: "purbayaya",
          icon: "💼",
          name: "Pak Purba-Yaya Dompet Negara",
        ...
        },
        {
          id: "syafri",
          icon: "🪖",
          name: "Jenderal Syafri Semua Urusan",
      ...
      [
        ...
        },
        {
          id: "rapi-ahmad",
          icon: "✨",
          name: "Mas Rapi Ahmad Utusan Serba Khusus",
      ...
      [
        {
          id: "dasko",
          icon: "🕶️",
          name: "Pak Dasko Koordinator Senyap",
        ...
        },
        {
          id: "yusrill",
          icon: "📜",
          name: "Pak Yus-Rill Pasal Berjalan",
    ...
    aktivis: [
      ...
      [
        ...
        },
        {
          id: "andhyta",
          icon: "🌱",
          name: "Andhyta Firselly Uta-Mikir",
  ...
  const cast = {
    power: [
      ...
      [
        "✨",
        "Mas Rapi Ahmad Utusan Serba Khusus",
  ...
  cast.activist.push(
    ["🧭","Om Dipo Peta Dunia","Arketipe diplomat-kritikus yang selalu bertanya strategic payoff setelah foto karpet merah selesai diunggah.","Parodi komposit atas debat kebijakan luar negeri."],
  ...
  sources.connie = [
    ...
    ["Karakter parodi-komposit","Prof. Konni Bakso-Rie adalah karakter fiksi satir yang mengambil inspirasi umum dari persona analis pertahanan di ruang publik. Dialog, ability, serta interaksinya dengan tokoh lain bukan rekonstruksi peristiwa nyata.","https://rmol.id/politik/read/2024/02/14/609364/pengamat-terorisme-ulta-levenia-pernyataan-connie-tidak-cerminkan-seorang-akademisi"]
  ];
  sources.ulta = [
  ...
  const specialEvents = [
    {
      ...
      actor: "Bang Dandhy Lensono & trio pakar konstitusi",
    ...
    },
    {
      ...
      actor: "Mas Rapi Ahmad & Om Dedi Cor-Buzzer",
    ...
    },
    {
      ...
      actor:
        "Pak Agus Harus Yakin Infrastruktur & Jenderal Syafri Semua Urusan",
    ...
    },
    {
      ...
      actor:
        "Pak Purba-Yaya versi prototipe & Pak Yus-Rill Pasal Berjalan",
    ...
    },
    {
      ...
      actor: "Pak Yus-Rill Pasal Berjalan & Keluarga Korban",
    ...
    },
    {
      ...
      actor:
        "Jerom Poling Data, Andovi da Loudspeaker, Abigail Literasia, dan kawan-kawan",
    ...
    },
    {
      ...
      after: 9,
      icon: "💼",
      title: "Pak Purba-Yaya Masuk Dompet Negara",
      actor: "Pak Purba-Yaya Dompet Negara",
    ...
    },
    {
      ...
      text: "Fatima Footnote dan mahasiswa membawa seruan Indonesia Bangkrut sebagai alarm politik, bukan laporan kepailitan. Pak Purba-Yaya membawa grafik makro; massa membawa harga pangan, PHK, kurs, biaya kuliah, dan masa depan yang terasa makin mahal.",
    ...
    },
    {
      ...
      fact: "Skenario fiksi pemilu digital.",
      sourceKey: "future",
      choices: {
        buzzer: [
          [
  ...
  specialEvents.push(
    {
      ...
      actor:"Prof. Konni Bakso-Rie, Dr. Ultima Waspadaban & Abu Jempol Nusantara",
      text:"Menjelang pemilu, satu klaim pertahanan masuk studio. Prof. Konni bentang peta sampai gelas host pindah meja; Dr. Ultima buka catatan sumber; Abu Jempol buka caps lock dan langsung menuduh remote TV antek asing. Produser senang: thumbnail merah, tiga kubu, iklan aman.",
  ...
  const personaPools = {
    good: ["genz","bapak","millennial","emak","anakpdf","ojol","anakKos","warung","asn"],
    bad: ["genz","fanwar","millennial","conspiracy","bapak","buzzerMagang","warung","emak"],
    neutral: ["bapak","genz","millennial","conspiracy","emak","anakpdf","ojol","anakKos","asn","warung"],
  };
  ...
  const phaseCommentTemplates = [
    ...
    [
      "Semua ini masih fiksi prediktif, tapi konsultan sudah mengirim invoice nyata.",
  ...
  const phaseTickers = [
    ...
    [
      "MBG MENYAJIKAN PORSI BESAR DAN LAMPIRAN PENGAWASAN KECIL",
      "INDONESIA GELAP, RILIS PERS TETAP TERANG",
      "UU TNI DIBAHAS CEPAT AGAR PUBLIK TIDAK KELELAHAN MEMBACA",
      "SATU PEJABAT EMPAT KURSI, TOKO MEBEL MENYATAKAN SIAGA",
  ...
  const voiceProfiles = [
    ...
    {
      match:
        /Purba-Yaya|Margin Error|Elektabilitas|Sampel Nasional|Grafik Revisi|Kalkulator/i,
    ...
    {
      match: /Guru Gembul-bul|Gembul/i,
    ...
    {
      match: /Dandhy Lensono|Layar Tancap/i,
  ...
  voiceProfiles.unshift(
    ...
    {match:/Akbar Fasal|akbarfasal/i,label:"MODE TANPA SENSOR & FOLLOW-UP",className:"voice-podcast",prefix:"Saya ulang pertanyaannya biar nggak kabur lewat jawaban normatif: ",suffix:" Jawabannya siapa, kapan, dan dokumennya mana. Bukan perasaan siapa yang terganggu."},
    ...
    {match:/Gita Wira-Wacana|gitawirawacana/i,label:"MODE LONG GAME",className:"voice-podcast",prefix:"Mari tarik sedikit ke horizon yang lebih panjang: ",suffix:" Tapi long game tetap harus membayar short invoice. Institusi nggak hidup dari thumbnail."},
    {match:/Latah-Hitung|latahhitung/i,label:"MODE KALKULATOR DOMPET",className:"voice-data",prefix:"Sebentar, kita hitung dulu. ",suffix:" Gratis itu cara menerima. Bukan cara membiayai. APBN nggak makan jargon."},
    ...
    {match:/Jenderal Gemoyono|@gemoyono|Gemoyono/i,label:"MODE PODIUM NYENYENYE",className:"voice-command",prefix:"Saudara-saudara... nyenyenye katanya ",suffix:" Ya sudah, yang penting merah putih. Kalau masih nanya, berarti mic saya kurang kencang."},
    ...
    {match:/Om Dipo Peta Dunia/i,label:"MODE FOREIGN POLICY THREAD",className:"voice-podcast",prefix:"Kita jujur aja ya: ",suffix:" Foto karpet merah itu bagus. Tapi strategic payoff-nya jangan ikut pulang naik pesawat kosong."},
    ...
    {match:/Guru Gembul-bul/i,label:"MODE BARAYA PANJANG",className:"voice-preacher",prefix:"Baraya, duduk dulu. Masalahnya gini: ",suffix:" Jangan cuma baca judul. Nanti komentar kita jadi praktikum sosiologi tanpa dosen."},
    ...
    {match:/Konni Bakso-Rie|konnibaksorie/i,label:"MODE PETA PERTAHANAN LIPAT TIGA",className:"voice-podcast",prefix:"Gue bentang peta dulu ya, gelasnya minggir: ",suffix:" Kalau mau bantah, bawa dokumen. Jangan cuma bawa potongan tujuh detik sama musik tegang."},
  ...
  const phasePunchlines = [
    ...
    "Ini fiksi prediktif. Invoice konsultannya sayangnya realistis.",
  ...
  const topicActionFlavor = {
    ...
    finance: {
      buzzer: {
        podcast: [
          "Undang Pak Purba-Yaya ke Podcast",
  ...
  const phaseVariantTokens = [
    ...
    [
      ...
      ["Efisiensi", "pakai bahasa penghematan sambil mengecek siapa yang sebenarnya disuruh nombok"],
      ["Indonesia Gelap", "masuk ke gelombang protes tanpa menganggap satu tagar mewakili semua tuntutan"],
      ...
      ["Kursi Komisaris", "angkat rangkap jabatan, konflik kepentingan, dan doa karier bernama insya Allah komisaris"],
    ],
    [
  ...
  function chooseRole(role) {
    Object.assign(state, {
      ...
      phase: 0,
      day: 1,
      money: roleData[role].money,
      reach: roleData[role].reach,
      credibility: roleData[role].credibility,
      integrity: roleData[role].integrity,
      stress: roleData[role].stress,
      democracy: roleData[role].democracy,
      network: roleData[role].network,
      heat: 25,
      resolve: 100,
      actions: 0,
      quizDeck: [],
  ...
  const crewThemeOverrides={
    ...
    "gemoyono":["military","geopolitics","election","public-opinion"],"tedi-beruang":["governance","media","institutions"],"bahlul":["economy","productivity","party","budget"],"hasbun-brief":["media","accountability","public-opinion","mbg"],
    ...
    "feri-ambyar":["law","constitution","election","accountability","governance","coalition","protest"],"bibitri":["law","constitution","parliament","accountability","governance","coalition","protest"],"dandhy":["media","accountability","film"],"dipo-peta":["geopolitics","institutions","economy"],"togar-toa":["protest","education","network"],
  ...
  const issueThemeRules={
    ...
    mbg:["mbg","makan bergizi","kotak makan","dapur"],risk:["risiko","risk","kerugian","jaminan"],"state-assets":["danantara","bumn","aset negara","superholding"],governance:["tata kelola","audit","komite","mandat"],
  ...
  function monthlyRosterSchedule(role,phase){
    ...
    const schedule=issues.map((issue,index)=>{
      ...
      const scored=roster.filter(c=>crewAvailableInMonth(c,month)).map(character=>{
        ...
        const freshness=seen===0?18:Math.min(12,Math.max(0,month-last)*3);
  ...
  function topicJoke(i, persona) {
    ...
    const bank = {
      ...
      future:{bapak:"Ramalan politik kayak cuaca: payungnya dijual konsultan.",genz:"fiksi prediktif tapi invoice-nya canon.",emak:"Tahun depan belum datang, tagihannya sudah salam kenal.",warung:"Belum kejadian, tim sukses sudah pesan spanduk."}
    };
  ...
  function showCast(group = "power") {
    const labels = {
      power: "Gemoyverse & Kabinet",
      activist: "Aktivis, Pakar & Influencer",
    };
    $("#modalContent").innerHTML =
      `<h2>Tokoh Republik Timeline</h2><p>Semua nama di bawah adalah plesetan atau karakter komposit. Deskripsinya menyindir jabatan, gaya komunikasi, dan fenomena publik—bukan menuduh kejahatan, kontrak buzzer, atau motif pribadi.</p><div class="cast-tabs"><button class="cast-tab ${group === "power" ? "active" : ""}" data-cast="power">Gemoyverse</button><button class="cast-tab ${group === "activist" ? "active" : ""}" data-cast="activist">Aktivis & Influencer</button></div><div class="cast-grid">${cast[group].map((c) => `<div class="cast-card"><b>${c[0]} ${c[1]}</b><small>${c[2]}</small><div class="real-note">${c[3]}</div></div>`).join("")}</div><button class="btn" id="closeCast" style="margin-top:14px">Tutup</button>`;
    $("#modal").classList.remove("hidden");
    document
  ...
  function showElectionNight(title, text, moral) {
    const [world, worldText] = legacyState(),
      accuracy = state.quizAnswered
        ? Math.round((state.quizCorrect / state.quizAnswered) * 100)
        : null,
      eventLegacy = eventLegacySummary();
    $("#modalContent").classList.add("final-modal");
    $("#modalContent").innerHTML =
      `<div class="finale-stage election-finale"><div class="finale-content"><section class="finale-copy"><span class="finale-kicker">MALAM PEMILU • 2029 • OPEN ENDING</span><h2>${world}</h2><p>${worldText}</p><p>Lima tahun kekuasaan tidak berakhir dengan satu montage kemenangan. Ia berubah menjadi aturan, ingatan, jaringan, ketakutan, dan kebiasaan. Pemilu berikutnya dimulai dari semua itu.</p></section><aside class="finale-visual" aria-label="Ilustrasi kotak suara"><div class="finale-visual-label">KOTAK SUARA TIDAK MEMILIKI NARATOR</div><div class="ballot-scene"><div class="ballot-box"><div class="ballot-paper"></div></div></div><div class="candidate-silhouettes"><div><span>◼</span>Kandidat A<br><small>kelanjutan</small></div><div><span>◆</span>Kandidat B<br><small>perubahan</small></div><div><span>▲</span>Kandidat C<br><small>kompromi baru</small></div><div><span>●</span>Kotak kosong?<br><small>apatisme / protes</small></div></div></aside><div class="open-ending">HASIL TIDAK DITULISKAN UNTUKMU.<br>Yang dituliskan adalah kondisi republik ketika hasil itu datang.</div><div class="legacy-grid"><div class="legacy-card"><b>Warisan ${moral}/100</b>${title}</div><div class="legacy-card"><b>Jejak Digital</b>${compactNumber(state.postMetrics.views)} tayangan terakhir • ${state.eventHistory.length} event • ${(state.crisisHistory || []).length} krisis • ${(state.abilityLog || []).length} crew call • ${state.perfectMatches||0} perfect match • ${state.crewMisfires||0} salah studio</div><div class="legacy-card"><b>Jejak Keputusan</b>${eventLegacy.title}<br><small>${eventLegacy.text}</small></div><div class="legacy-card"><b>Literasi</b>${accuracy === null ? "Mode tanpa kuis" : accuracy + "% jawaban tepat"}</div></div><div class="finale-actions"><button class="btn" id="newCycle">Mulai Siklus Baru</button><button class="btn secondary" id="closeEnd">Lihat Timeline Terakhir</button></div></div></div>`;
    $("#newCycle").onclick = () => {
      const legacy = {
        role: state.role,
  ...
  function showEnding(crashed = false) {
    $("#modalContent").classList.remove("final-modal");
    state.finished = true;
    const [title, text] = endingData(crashed),
      moral = Math.round(
        (state.integrity + state.credibility + state.democracy) / 3,
      ),
      eventLegacy = eventLegacySummary();
    clearSave();
    $("#modalContent").innerHTML =
      `<div class="finale-stage"><div class="finale-content"><span class="finale-kicker">ENAM TAHUN • 72 BULAN • ${state.eventHistory.length} SPECIAL EVENT • ${(state.crisisHistory || []).length} KRISIS • ${state.bailoutCount || 0} BAILOUT</span><h2>${title}</h2><p>${text}</p><div class="ending-score"><div><strong>${Math.round(state.reach)}</strong>Jangkauan</div><div><strong>${Math.round(state.integrity)}</strong>Integritas</div><div><strong>${Math.round(state.democracy)}</strong>Demokrasi</div><div><strong>${state.career}</strong>Karier</div><div><strong>${formatMoney(state.debt || 0)}</strong>Utang</div></div><div class="lesson"><b>INDEKS WARISAN: ${moral}/100</b><br>Ini bukan skor kemenangan kubu. Ini ukuran kasar tentang kualitas ruang publik yang tersisa ketika pemilu berikutnya datang.</div><div class="lesson"><b>${eventLegacy.title}</b><br>${eventLegacy.text}</div><div class="lesson"><b>JEJAK ENAM TAHUN</b><br>Konstitusi → transisi → MBG dan Kopdes → ruang sipil → hukum → rupiah dan IHSG → PLN serta bencana → geopolitik → pra-pemilu → kotak suara. Final ini membawa konsekuensi dari arc sebelumnya, bukan mengundi headline baru.</div><p><b>Bab terakhir belum selesai.</b> Kotak suara 2029 menunggu, tetapi game tidak akan memilihkan presiden untukmu.</p><button class="btn" id="electionNight">Masuk Malam Pemilu</button></div></div>`;
    $("#modal").classList.remove("hidden");
    $("#electionNight").onclick = () =>
      showElectionNight(title, text, moral);
    beep(110, 0.25);
  }
